...
電池供應鏈情報追蹤。每天自動抓取供應鏈上下游公司的新聞與股價，用規則引擎標記重要性與異常，產出每日與 7 日報告，並在網頁上呈現供應鏈關係圖與事件時間軸。

線上看：<http://battery.intel.weiqi.kids/>

## 現在追蹤什麼

- 公司 19 家，分佈在上中下游，設定在 `configs/companies.yml`（含關聯的上下游對象，供應鏈圖就是從這裡長出來的）
