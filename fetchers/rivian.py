...
class RivianFetcher(CompanyFetcher):
    """Rivian 爬蟲"""

    company_id = "rivian"
    company_name = "Rivian"
    news_url = "https://www.rivian.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Rivian")
        return documents
