...
class EveFetcher(CompanyFetcher):
    """EVE Energy 爬蟲"""

    company_id = "eve"
    company_name = "EVE Energy"
    news_url = "https://www.eveenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.eveenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from EVE Energy")
        return documents
