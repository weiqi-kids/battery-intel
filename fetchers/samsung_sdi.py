...
class SamsungSdiFetcher(CompanyFetcher):
    """Samsung SDI 爬蟲"""

    company_id = "samsung_sdi"
    company_name = "Samsung SDI"
    news_url = "https://www.samsungsdi.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.samsungsdi.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Samsung SDI")
        return documents
