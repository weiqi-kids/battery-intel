...
class GanfengFetcher(CompanyFetcher):
    """Ganfeng Lithium 爬蟲"""

    company_id = "ganfeng"
    company_name = "Ganfeng Lithium"
    news_url = "https://www.ganfenglithium.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.ganfenglithium.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Ganfeng Lithium")
        return documents
