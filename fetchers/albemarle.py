...
class AlbemarleFetcher(CompanyFetcher):
    """Albemarle 爬蟲"""

    company_id = "albemarle"
    company_name = "Albemarle"
    news_url = "https://www.albemarle.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.albemarle.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Albemarle")
        return documents
