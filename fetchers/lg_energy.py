...
class LgEnergyFetcher(CompanyFetcher):
    """LG Energy Solution 爬蟲"""

    company_id = "lg_energy"
    company_name = "LG Energy Solution"
    news_url = "https://www.lgenergysolution.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.lgenergysolution.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from LG Energy Solution")
        return documents
