...
class PanasonicFetcher(CompanyFetcher):
    """Panasonic 爬蟲"""

    company_id = "panasonic"
    company_name = "Panasonic"
    news_url = "https://www.panasonic.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.panasonic.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Panasonic")
        return documents
