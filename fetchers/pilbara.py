...
class PilbaraFetcher(CompanyFetcher):
    """Pilbara Minerals 爬蟲"""

    company_id = "pilbara"
    company_name = "Pilbara Minerals"
    news_url = "https://www.pilbaraminerals.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.pilbaraminerals.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Pilbara Minerals")
        return documents
